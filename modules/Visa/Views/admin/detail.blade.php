...
@section('content')
    <form action="{{route('visa.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        @csrf
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    ...
                    @if($row->slug)
                        <p class="item-url-demo">{{__("Permalink")}}: {{ url('visa' ) }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a>
                        </p>
                    @endif
                </div>
                <div class="">
                    @if($row->slug)
                        <a class="btn btn-primary btn-sm" href="{{$row->getDetailUrl(request()->query('lang'))}}" target="_blank">{{__("View Visa")}}</a>
                    @endif
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        @include('Visa::admin.visa.location')
                        @include('Visa::admin.visa.pricing')
                        @if(is_default_lang())
                            {{--@include('Visa::admin.visa.availability')--}}
                        @endif
                    ...
                    <div class="col-md-3">
                        ...
                        @if(is_default_lang())
                            ...
                            @include('Visa::admin.visa.attributes')
                            @include('Visa::admin.visa.ical')
                            <div class="panel">
