...
<div class="panel">
    ...
    <div class="panel-body">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="number" step="any" min="0" name="number" class="form-control" value="{{$row->number}}" placeholder="{{__("Visa Number")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Price")}}</label>
                        <input type="number" step="any" min="0" name="price" class="form-control" value="{{$row->price}}" placeholder="{{__("Visa Price")}}">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="form-group">
                        <label class="control-label">{{__("Sale Price")}}</label>
                        <input type="number" step="any" name="sale_price" class="form-control" value="{{$row->sale_price}}" placeholder="{{__("Visa Sale Price")}}">
        ...
        @if(is_default_lang() and (!empty(setting_item("visa_allow_vendor_can_add_service_fee")) or is_admin()))
            <hr>
...
@endif
<?php do_action(\Modules\Visa\Hook::FORM_AFTER_SERVICE_FEE,$row) ?>